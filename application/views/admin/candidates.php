		...
		$("form#jobs_form").submit(function(e) {
            ...
            <div class="box-header">
			 <div class="pull-left">
				 ...
				 <div class="pull-right">
                  <!--<button type="button" onclick="window.location.href='<?php echo base_url('admin/add-candidate');?>'" class="btn btn-block btn-primary">Add</button>-->
                </div>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="candidate_data" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>ID</th>
                  <th>Full name</th>
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url('admin/view-candidate-messages/'.$val->id)?>" ><i class="fa fa-comments"></i></a></td>
                  <td><?php echo $val->phone_number;?></td>
                  <td><?php echo $val->address;?></td>
                  <td><?php echo $val->current_job_title;?></td>
                  <td><?php echo $val->experience;?></td>
                  <td><?php echo $val->created_at;?></td>
                  <!--<td>
					<a href="<?php echo base_url('admin/edit-candidate/'.$val->id)?>" ><i class="fa fa-fw fa-edit"></i></a>
					<a href="<?php echo base_url('admin/delete-candidate/'.$val->id)?>" ><i class="fa fa-fw  fa-trash"></i></a>
				  </td>-->
