						...
						<div class="col-md-12">
							<div class="widget-area-2 proclinic-box-shadow pb-3">
								...
								<div class="form-group col-md-12 ">
										...
										?>
										<input  disabled style="margin: 0 0 0px 0 !important;cursor: pointer;" class="form-control" value="<?php echo isset($order_status)?$order_status:0; ?>"  id="order_status" type="range" min="0" max="2" value="0" id="fader" 
										step="1" >
									...
									<div class="form-group col-md-12">
										...
										<br>
										<br>
										<span id="carrier_name_span" >Carrier Name: <strong><?php echo isset($service_code)?strtoupper($service_code):"N/A" ?></strong></span>
										<br>
										<span id="shipping_amount" >Shipping Amount: <strong><?php echo isset($shipping_amount)?($shipping_currency." ".$shipping_amount):"N/A" ?></strong></span>
										<br>
										<span id="order_date">Order Date: <strong><?php echo isset($order_date)?$order_date:"December 16, 2017"?></strong></span>
										<br>
										<span id="tracking_status">Tracking Status: <strong><?php echo isset($tracking_status)?strtoupper($tracking_status):"N/A"?></strong></span>
										<br>
										<span id="tracking_status_description">Tracking Status Description: <strong><?php echo isset($tracking_status_description)?($tracking_status_description):"N/A"?></strong></span>
										<br>
										<span id="shipment_status">Shipment Status: <strong><?php echo isset($shipment_status)?$shipment_status:"N/A"?></strong></span>
										<br>
										<span id="label_id">Label: <strong><?php echo isset($label_id)?$label_id:"N/A"?></strong></span>
										<br>
										<span id="label_status">Label Status: <strong><?php echo isset($label_status)?$label_status:"N/A"?></strong></strong></span>
										<br>
										<span id="label_download">Label Download: <strong><?php if(isset($label_download) && $label_download!=""){?><a  target="_blank" style="color:#007bff !important;" href="<?php echo $label_download;?>"><?php echo isset($label_download)?"View":"N/A"; ?></a><?php }else{ echo "N/A";} ?></span>
										<br>
										<span id="carrier_status_description">Carrier Status Description: <strong><?php echo isset($carrier_status_description)?$carrier_status_description:"N/A"?></strong></span>
										<br>
										<span id="actual_delivery_date">Actual Delivery Date: <strong><?php echo isset($actual_delivery_date)?$actual_delivery_date:"N/A"?></strong></span>
										<br>
										<span id="estimated_delivery_date">Estimated Delivery Date: <strong><?php echo isset($estimated_delivery_date)?$estimated_delivery_date:"N/A"?></strong></span>
								...
								<a class="btn btn-primary" href="<?php echo base_url("order-summary/".$order_id)?>" role="button">Back to Summary</a>
