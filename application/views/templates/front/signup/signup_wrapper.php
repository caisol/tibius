                        ...
                        <div class="login_form_wrapper signup_wrapper">
                            ...
                            <h2>sign up</h2>
							   <!--<div class="form-group icon_form comments_form">
                                ...
                                <input type="text" class="form-control require" name="full_name" id="full_name" placeholder="Full Name*">
                            ...
                            <div class="form-group icon_form comments_form">
                                ...
                                <input type="password" name="password" id="password" class="form-control require" placeholder="Create Password *">
                                <i class="fas fa-lock"></i>
                            </div>
							
							<div class="form-group icon_form comments_form">

                                <input type="password" name="cpassword" id="cpassword" class="form-control require" placeholder="Confirm Password *">
                                <i class="fas fa-lock"></i>
                            </div>
                            ...
                            <div class="dont_have_account jb_cover">
                                <p>Have an acount ? <a href="<?php echo base_url('login'); ?>">login</a></p>
                            </div>
							</form>
                        </div>
                    </div>
		...
		document.addEventListener("DOMContentLoaded", function(event) { 
			$("#submit_btn").click(function(){
				...
				/*if(full_name.length == 0)
				{
					...
					$("#full_name").attr('placeholder','Full name is required');
				}
				...
				else if(cpassword.length == 0)
				{
					...
					$("#cpassword").attr('placeholder','Confirm password is required');
				}
				else if(cpassword!=password)
				{
					$('#message_div').css('display','block');
					$('#message_lbl').html("Password and Confirm Password are not matched!");
					setTimeout(function() { $("#message_div").hide(); }, 5000);
				}
				else
				{
					
				$.post( "<?php echo base_url('signup-submit');?>", { /*full_name: full_name,*/ email: email, password: password })
				  .done(function( data ) {
