                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">      
                                    <div class="manage_jobs_wrapper jb_cover">
                                        <div class="job_list mange_list applications_recent">
                                            ...
                                            <h6><?php echo isset($favourite_jobs)?count($favourite_jobs):0; ?> favourite</h6>

                                        </div>
                                    </div>
                        </div>
					<?php if(isset($favourite_jobs) && !empty($favourite_jobs)) { 
					foreach($favourite_jobs as $key=>$val) { ?>
					 <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                                        <div class="jb_job_post_right_btn_wrapper">
                                            <ul>
                                                ...
                                                <li> <a href="javascript:void(0);" id="apply_now">apply</a></li>
				...
				
				{
					...
					$.ajax({
						...
						success: function (data) {
							...
							window.location.replace("<?php echo base_url('favourite-jobs')?>");
						},
						cache: false,
						contentType: false,
						processData: false
